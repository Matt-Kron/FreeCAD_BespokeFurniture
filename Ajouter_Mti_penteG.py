...
def AjouterMontantIntermediaire():
    ...
    for ele in liste_elements:
        if "Mt_i_pente_G" in ele[OBJ_NAME]:
            elements_Mti.append(ele)
    piece = monDoc.addObject('App::Part', "Mt_i_pente_G_p")
    etiquette = "Mt i pente G p"
    piece.Label = "Mt i pente G p"
    ...
    corps = monDoc.addObject('PartDesign::Body',"Mt_i_pente_G_b")
    corps.Label = "Mt i pente G b"
